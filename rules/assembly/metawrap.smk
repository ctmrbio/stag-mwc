...
rule binning:
    ...
    input:
        ...
        read2=f"{OUTDIR}/host_removal/{{sample}}_2.fq.gz",
    output:
        concoct_bins=directory(f"{OUTDIR}/metawrap/binning/{mw_config['assembler']}/{{sample}}/concoct_bins"),
        #maxbin2_bins=directory(f"{OUTDIR}/metawrap/binning/{mw_config['assembler']}/{{sample}}/maxbin2_bins"),
        metabat2_bins=directory(f"{OUTDIR}/metawrap/binning/{mw_config['assembler']}/{{sample}}/metabat2_bins"),
    log:
        stdout=f"{LOGDIR}/metawrap/{mw_config['assembler']}/{{sample}}.binning.stdout.log",
        stderr=f"{LOGDIR}/metawrap/{mw_config['assembler']}/{{sample}}.binning.stderr.log",
    shadow:
        "shallow"
    conda:
        "../../envs/assembly.yaml"
...
rule consolidate_bins:
    ...
    log:
        stdout=f"{LOGDIR}/metawrap/{mw_config['assembler']}/{{sample}}.consolidate_bins.stdout.log",
        stderr=f"{LOGDIR}/metawrap/{mw_config['assembler']}/{{sample}}.consolidate_bins.stderr.log",
    shadow:
        "shallow"
    conda:
        "../../envs/assembly.yaml"
    ...
    params:
        outdir=lambda w: f"{OUTDIR}/metawrap/consolidated_bins/{mw_config['assembler']}/{w.sample}",
...
rule blobology:
    ...
    log:
        stdout=f"{LOGDIR}/metawrap/{mw_config['assembler']}/{{sample}}.blobology.stdout.log",
        stderr=f"{LOGDIR}/metawrap/{mw_config['assembler']}/{{sample}}.blobology.stderr.log",
    shadow:
        "shallow"
    conda:
        "../../envs/assembly.yaml"
